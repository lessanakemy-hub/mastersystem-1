export default function ComexPage() {
  return (
    <div className="space-y-8">
      <div className="pb-2">
        <h1 className="text-2xl font-semibold tracking-tight text-slate-900">Comex Operations</h1>
      ...
      <div className="glass-card flex min-h-[400px] items-center justify-center rounded-xl p-8">
        <p className="text-sm text-slate-500">Módulo Comex em desenvolvimento</p>
      </div>
    </div>
  );
}
