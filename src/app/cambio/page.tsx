...
export default function CambioPage() {
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="glass-card rounded-xl p-6">
          ...
          {editPtax ? (
            <div className="mt-3 flex items-center gap-2">
              ...
              <input
                ...
                className="w-24 rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 outline-none transition-colors focus:border-slate-300 focus:ring-1 focus:ring-slate-200"
              />
              <button
                type="button"
          ...
          {!editPtax && (
            <button
              ...
              className="mt-2 text-sm font-medium text-slate-600 transition-colors hover:text-slate-900"
            >
              Editar cotação
            </button>
          )}
      ...
      <div className="glass-card rounded-xl p-6">
        <h3 className="text-base font-semibold text-slate-900">Conversor</h3>
        <p className="mt-1.5 text-sm text-slate-500">
        ...
        <div className="mt-6 flex flex-wrap gap-4">
          <div className="rounded-xl border border-slate-200 bg-slate-50/80 px-5 py-4 transition-colors hover:bg-slate-100/80">
            <p className="text-xs font-medium text-slate-500">US$ 1.000 =</p>
            <p className="mt-1 text-lg font-semibold tabular-nums text-slate-900">
              {formatMoeda(1000 * ptaxUSD, "BRL")}
            </p>
          </div>
          <div className="rounded-xl border border-slate-200 bg-slate-50/80 px-5 py-4 transition-colors hover:bg-slate-100/80">
            <p className="text-xs font-medium text-slate-500">US$ 10.000 =</p>
            <p className="mt-1 text-lg font-semibold tabular-nums text-slate-900">
              {formatMoeda(10000 * ptaxUSD, "BRL")}
            </p>
          </div>
          <div className="rounded-xl border border-slate-200 bg-slate-50/80 px-5 py-4 transition-colors hover:bg-slate-100/80">
            <p className="text-xs font-medium text-slate-500">US$ 100.000 =</p>
            <p className="mt-1 text-lg font-semibold tabular-nums text-slate-900">
